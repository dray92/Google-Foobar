...
public class Maximum_Equality {
	public static int answer(int[] x) { 
        ...
        // Your code goes here.
        int len = x.length; // number of cars
        
        int sum = 0;    // total rabbits available
        
        // get number of rabbits
        for(int rabbits: x)
            sum += rabbits;
            
        // if number of rabbits in each car
        // is set to be the number of cars
        // then, we will either have numCars
        // cases of equality, or numCars-1 
        // cases of equality
        // check -> [1,1,1]
        // sum = 3
        // sum%len(check) = 0
        // so, 3 cars of equality
        // if check -> [1,2,2]
        // max is 2 cars of equality
        // sum = 5
        // sum%len(check) = 2
        // so, max = len(check)-1
        if(sum%len == 0)
